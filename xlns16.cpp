...
//    todo:  a Mitchell method for the non-ideal case
...
float xlns162fp(xlns16 x)
{
	if (xlns16_abs(x) == xlns16_zero)
		...
		return (float) (-pow(2.0,((float) (((xlns16_signed) (xlns16_abs(x)-xlns16_logsignmask))))
					/((float) xlns16_scale)));
	else {
		return (float) (+pow(2.0,((float) (((xlns16_signed) (xlns16_abs(x)-xlns16_logsignmask))))
					/((float) xlns16_scale)));
	...
	//else if (xlns16_sign(x))
		//return (float) (-pow(2.0,((float) (((xlns16_signed) xlns16_abs(x^xlns16_logsignmask))<<1)/2)
		//			/((float) xlns16_scale)));
	//else {
	//	return (float) (+pow(2.0,((float) (((xlns16_signed) xlns16_abs(x^xlns16_logsignmask))<<1)/2)
	//				/((float) xlns16_scale)));
